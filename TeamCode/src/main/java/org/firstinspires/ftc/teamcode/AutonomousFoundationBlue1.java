...
@Autonomous(name="Autonomous - Foundation Blue 1", group="BB")
public class AutonomousFoundationBlue1 extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        robot.RobotMoveY(new Waypoint(0, 85, 0), 0.3);
        robot.Stop();
        sleep(100);
        ...
        robot.RobotMoveY(new Waypoint(0, -65, 0), 0.4);
        robot.Stop();
        sleep(100);
        ...
        robot.RobotMoveY(new Waypoint(0 , -10, 0), 0.3);
        robot.Stop();
        sleep(100);
